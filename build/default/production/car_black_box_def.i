    ...
    if (i == 4)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                clcd_putch(attempts_left + '0', (0xC0 + 0));
...
static void get_saved_log(unsigned char view_pos)
{
    ...
    unsigned char addr = (view_pos) * 10 + 5;
...
static void print_log(unsigned char view_pos)
{
    ...
    clcd_putch(view_pos + '0', (0xC0 + 0));
    clcd_putch(saved_time[0], (0xC0 + 2));
    clcd_putch(saved_time[1], (0xC0 + 3));
    clcd_putch(':', (0xC0 + 4));
    clcd_putch(saved_time[2], (0xC0 + 5));
    clcd_putch(saved_time[3], (0xC0 + 6));
    clcd_putch(':', (0xC0 + 7));
    clcd_putch(saved_time[4], (0xC0 + 8));
    clcd_putch(saved_time[5], (0xC0 + 9));

    clcd_putch(saved_ev[0], (0xC0 + 11));
    clcd_putch(saved_ev[1], (0xC0 + 12));

    clcd_putch(saved_sp[0], (0xC0 + 14));
    clcd_putch(saved_sp[1], (0xC0 + 15));
}
...
unsigned char view_log(unsigned char key, unsigned char reset_flag)
{
    ...
    if (key == 0x37 && sw_p == 0x02)
    {
        return_time = 5;
        return 0xF1;
    }

    else if (key == 0x2F && sw_p == 0x02)
        return 0xF0;
...
unsigned char change_passwd(unsigned char key, unsigned char reset_flag)
{
    ...
    if (flag == 0 && i == 4)
    {
        ...
        flag = 1;
        clear_screen();
        clcd_print("Renter passwd", (0x80 + 0));
    ...
    if (flag == 1 && i == 4)
    {
        ...
        else
        {
            ...
            clcd_print("not matching", (0xC0 + 0));
        }
