...
void main(void) {
    ...
    unsigned char operation_flag = 0x01, reset_flag = 0x00 ;
    ...
    while (1) {
        ...
        if (operation_flag == 0x01 || operation_flag == 0x02 || operation_flag == 0x08)
        {
            key = read_digital_keypad(1);
            for (unsigned int i = 300; i--; );
        }
        else if (operation_flag == 0x03 || operation_flag == 0x04 || operation_flag == 0x07)
        {
        ...
        else if (operation_flag == 0x01 && (key == 0x37 || key == 0x2F))
        {
            operation_flag = 0x02;
            reset_flag = 0x11;
            clear_screen();
        ...
        else if (operation_flag == 0x03 && sw_p == 0x02 && key == 0x37)
        {
            switch(menu)
            {
                case 0:
        ...
        else if (operation_flag == 0x03 && sw_p == 0x02 && key == 0x2F)
        {
            operation_flag = 0x01;
            clear_screen();
            press_time = 0;
